...
public class Casita {
	...
	private byte colores[] = new byte[] { 
			...
			(byte)244, (byte)233, (byte)102, 1, // 3
			//atras alto
			(byte)248, (byte)220, (byte)63, 1, // 0
			(byte)248, (byte)220, (byte)63, 1, // 1
			(byte)248, (byte)220, (byte)63, 1, // 2
			(byte)248, (byte)220, (byte)63, 1, // 3
			//atras ancho
			(byte)248, (byte)220, (byte)63, 1, // 0
			(byte)248, (byte)220, (byte)63, 1, // 1
			(byte)248, (byte)220, (byte)63, 1, // 2
			(byte)248, (byte)220, (byte)63, 1, // 3
			//pared izq arriba
			(byte)246, (byte)238, (byte)149, 1, // 0
			(byte)246, (byte)238, (byte)149, 1, // 1
			(byte)246, (byte)238, (byte)149, 1, // 2
			(byte)246, (byte)238, (byte)149, 1, // 3
			...
			(byte)246, (byte)238, (byte)149, 1, // 3
			//pared der arriba
			(byte)221, (byte)211, (byte)94, 1, // 0
			(byte)221, (byte)211, (byte)94, 1, // 1
			(byte)221, (byte)211, (byte)94, 1, // 2
			(byte)221, (byte)211, (byte)94, 1, // 3
			//pared der abajo
			(byte)221, (byte)211, (byte)94, 1, // 0
			(byte)221, (byte)211, (byte)94, 1, // 1
			(byte)221, (byte)211, (byte)94, 1, // 2
